...
# Compatibility symlink so older scripts or paths continue to work
ln -sf Distanser.app build/Ruler.app 2>/dev/null || true

echo "Built $APP — version $VERSION, $(lipo -archs "$APP/Contents/MacOS/Distanser")"
